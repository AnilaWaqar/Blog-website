...
function page() {
  return (
    <div className='sm:mx-20 mx-10 my-10 text-white text-lg flex flex-col gap-5'>
      <h1 className='sm:text-4xl text-2xl text-center uppercase  font-semibold'>About SR Blogs</h1>
      <p>Welcome to SR Blog a space where ideas, knowledge, and creativity converge. Whether you are here to explore technology trends, gain insights into personal growth, or discover fresh perspectives, our blog is your destination for thoughtful and engaging content.</p>
